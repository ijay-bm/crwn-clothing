...
export const errorMap: Record<string, string> = {
  ...
  "auth/invalid-argument": "An invalid argument was providedd to an Authentication method. The error message should contain additional information.",
  "auth/invalid-claims": "The custom claim attributes provied to setCustomUserClaims() are invalid.",
  ...
  "auth/auth-domain-config-required": "An auth domain must be configured in the Firebase console.",
  "auth/cancelled-popup-request": "The popup request was cancelled before it completed.",
  ...
  "auth/user-token-expired": "The user's authentication token has expired. Please sign in again.",
  "auth/requires-recent-login": "This operation requires a recent sign-in. Please sign in again.",
  "auth/no-such-provider": "The authentication provider is not enabled for this project.",
  ...
  "auth/missing-verification-code": "A verification code is required to complete the sign-in process.",
  "auth/missing-verification-id": "A verification ID is required to complete the sign-in process.",
  "auth/missing-phone-number": "A phone number is required to complete the sign-in process.",
};
